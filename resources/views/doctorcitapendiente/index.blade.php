...
@section('title', 'Citas medicas pendientes')

@section('content_header')
    <h1>Gestión de citas medicas pendientes</h1>
@stop
                    ...
                    <tr>
                        ...
                        <td class="d-flex"> 
                            ...
                            <button class="btn btn-xs btn-default text-primary shadow btn-edit" 
                                ...
                                data-url="{{ route('doctorcitapendiente.edit', $citamedica->id) }}" 
                                data-update="{{ route('doctorcitapendiente.update', $citamedica->id) }}" >
                                <i class="fa fa-lg fa-fw fa-pen"></i>
...
=======
    ...
    <div>
        @include('doctorcitapendiente.update_estatus')
